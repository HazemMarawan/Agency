    ...
    public class GroupController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (Request.IsAjaxRequest())
            {
                ...
                // Getting all data    
                var permissionGroupsData = db.PermissionGroups.Select(s => new PermissionGroupViewModel
                {
                    id = s.id,
                    name = s.name,
        ...
        public JsonResult savePermissionGroup(PermissionGroupViewModel PermissionGroupVM)
        {
            ...
            else
            {
                ...
                PermissionGroup oldPermissionGroup = db.PermissionGroups.Find(PermissionGroupVM.id);
        ...
        public JsonResult deletePermissionGroup(int id)
        {
            ...
            PermissionGroup deletePermissionGroup = db.PermissionGroups.Find(id);
