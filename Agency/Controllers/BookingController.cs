...
namespace Agency.Controllers
{
    public class BookingController : Controller
    {
        ...
        public ActionResult BalancePDF(int reservation_id)
        {
            ...
            resData.welcome_message = resData.welcome_message.Replace("_Name", resData.reservations_officer_name);
            resData.welcome_message = resData.welcome_message.Replace("_Due_date", resData.balance_due_date.ToString().Split(' ')[0]);
        ...
        public ActionResult CreditPDF(int reservation_id)
        {
            MailServer mailServer = db.MailServers.Where(ms => ms.type == 4).FirstOrDefault();
            ...
            var report = new Rotativa.ViewAsPdf("CreditPDF", resData);
            return report;
        }
    }
}